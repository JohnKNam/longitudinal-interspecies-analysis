...
CR_FBG <- read_excel("data/nhp/NHP_NIA_raw/Copy of #2 - CR Study_FBG Data.xlsx", skip = 2)
other_FBG <- read_excel("data/nhp/NHP_NIA_raw/Copy of #4  - Other Rhesus_FBG Data.xlsx")
CR_dexa <- read_excel("data/nhp/NHP_NIA_raw/Copy of NHP-NIA_LT CR dexa data_Michel.xlsx", sheet = "initial dataset")
surv_grp <- read_excel("data/nhp/NHP_NIA_raw/NIA_mortality_list2_update032020_v2.xlsx")
...
FBG <- read_excel("data/nhp/NHP_WIS_raw/Copy of Control Glucose_.xlsx", sheet = "Basal Glucose")
IVGTT <- read_excel("data/nhp/NHP_WIS_raw/Copy of Control Glucose_.xlsx", sheet = "Glucose from IVGTT")
DEXA <- read_excel("data/nhp/NHP_WIS_raw/Copy of WIS-NHP DXA data_Michel.xlsx", sheet = "raw data")
surv_cat <- read_excel("data/nhp/NHP_WIS_raw/Euth.Nat.xlsx")
surv_date <- read_excel("data/nhp/NHP_WIS_raw/GlucoseDate.DOBDOD.xlsx")
...
census_c16_death <- census %>% 
  ...
  select(idno, dead_censor, fu_age_wk, le_wk, cod, diabetes2, sex, strain)
...
gluc_peak_nia <- lifespan_peaks(metric = "gluc", data = main_all2, filter = quote(strain %in% c("nia"))) 
bw_peak_nia <- lifespan_peaks(metric = "bw", data = main_all2, filter = quote(strain %in% c("nia"))) 
fat_peak_nia <- lifespan_peaks(metric = "fat", data = main_all2, filter = quote(strain %in% c("nia"))) 

gluc_peak_wis <- lifespan_peaks(metric = "gluc", data = main_all2, filter = quote(strain %in% c("wis"))) 
bw_peak_wis <- lifespan_peaks(metric = "bw", data = main_all2, filter = quote(strain %in% c("wis"))) 
fat_peak_wis <- lifespan_peaks(metric = "fat", data = main_all2, filter = quote(strain %in% c("wis"))) 
...
```{r nhp_main_all3, warning=FALSE, message=FALSE, echo=FALSE, eval=TRUE}
...
surv_color2 <- c("yellow", "red", "purple", "gray")
...
#sex
nhp_fig_i1 <- fcn_plotdist_smooth(metric = "gluc", x = "per_age_wk", xlabel = "Percent Life Expectancy", xlow = 0, xhigh = 170, 
...
nhp_fig_i2 <- fcn_plotdist_smooth(metric = "bw", x = "per_age_wk", xlabel = "Percent Life Expectancy", xlow = 0, xhigh = 150, 
                        y = "bw", ylabel = "Body Weight (kg)", by = "sex", peak1 = bw_peak_male, peak2 = bw_peak_female) + 
  scale_color_manual(labels = c("Female", "Male"), name = "Sex", values = cbPalette_dot)
nhp_fig_i3 <- fcn_plotdist_smooth(metric = "fat", x = "per_age_wk", xlabel = "Percent Life Expectancy", xlow = 0, xhigh = 150, 
                        y = "fat", ylabel = "Body Fat (kg)", by = "sex", peak1 = fat_peak_male, peak2 = fat_peak_female) + 
  scale_color_manual(labels = c("Female", "Male"), name = "Sex", values = cbPalette_dot)
#colony
nhp_fig_j1 <- fcn_plotdist_smooth(metric = "gluc", x = "per_age_wk", xlabel = "Percent Life Expectancy", xlow = 0, xhigh = 170, 
...
nhp_fig_j2 <- fcn_plotdist_smooth(metric = "bw", x = "per_age_wk", xlabel = "Percent Life Expectancy", xlow = 0, xhigh = 150, 
                        y = "bw", ylabel = "Body Weight (kg)", by = "strain", peak1 = bw_peak_nia, peak2 = bw_peak_wis) + 
  scale_color_manual(labels = c("NIA", "WIS"), name = "Colony", values = cbPalette_dot)
nhp_fig_j3 <- fcn_plotdist_smooth(metric = "fat", x = "per_age_wk", xlabel = "Percent Life Expectancy", xlow = 0, xhigh = 150, 
                        y = "fat", ylabel = "Body Fat (kg)", by = "strain", peak1 = fat_peak_nia, peak2 = fat_peak_wis) + 
  scale_color_manual(labels = c("NIA", "WIS"), name = "Colony", values = cbPalette_dot)
#diabetes
nhp_fig_diab1 <- fcn_plotdist_smooth(metric = "gluc", x = "per_age_wk", xlabel = "Percent Life Expectancy", xlow = 0, xhigh = 170, 
...
nhp_fig_diab2 <- fcn_plotdist_smooth(metric = "bw", x = "per_age_wk", xlabel = "Percent Life Expectancy", xlow = 0, xhigh = 150, 
                        y = "bw", ylabel = "Body Weight (kg)", by = "diabetes2", peak1 = bw_peak_diab, peak2 = bw_peak_nondiab) + 
  scale_color_manual(labels = c("Diabetic", "Non-Diabetic"), name = "Health Status", values = cbPalette_dot)
nhp_fig_diab3 <- fcn_plotdist_smooth(metric = "fat", x = "per_age_wk", xlabel = "Percent Life Expectancy", xlow = 0, xhigh = 150, 
                        y = "fat", ylabel = "Body Fat (kg)", by = "diabetes2", peak1 = fat_peak_diab, peak2 = fat_peak_nondiab) + 
  scale_color_manual(labels = c("Diabetic", "Non-Diabetic"), name = "Health Status", values = cbPalette_dot)
#death
nhp_fig_d1 <- fcn_plotdist_lm(metric = "gluc", x = "per_age_wk", xlabel = "Percent Life Expectancy", xlow = 0, xhigh = 170, 
                        y = "gluc", ylabel = "Glucose (mg/dL)", by = "whendead") +
    scale_color_manual(values = surv_color, name = "Survival\n(% Life Expectancy)")
nhp_fig_d2 <- fcn_plotdist_lm(metric = "bw", x = "per_age_wk", xlabel = "Percent Life Expectancy", xlow = 0, xhigh = 150, 
                        y = "bw", ylabel = "Body Weight (kg)", by = "whendead") +
    scale_color_manual(values = surv_color2, name = "Survival\n(% Life Expectancy)")
nhp_fig_d3 <- fcn_plotdist_lm(metric = "fat", x = "per_age_wk", xlabel = "Percent Life Expectancy", xlow = 0, xhigh = 150, 
...
annotate_figure(nhp_fig_j13, 
                top = text_grob("Trends in Metabolic Indices over the Lifespan by Colony", size = 12, hjust = 0, x = unit(0, "lines")), 
                bottom = text_grob("Note: Diamonds represent age at peak index value", size = 9, hjust = 0, x = unit(0, "lines")) 
                ) 
``` 
...
#function calls 
nhp_surv_gluc_50_all <- km_funct(quart = "gluc_50_quart", exp_var = c("per_age_wk_50"), start = km_start_50, data = main_cat_surv, title = "Glucose at 50% Life Expectancy", end = 180) 
nhp_surv_gluc_75_all <- km_funct(quart = "gluc_75_quart", exp_var = c("per_age_wk_75"), start = km_start_75, data = main_cat_surv, title = "Glucose at 75% Life Expectancy", end = 180) 
nhp_surv_gluc_100_all <- km_funct(quart = "gluc_100_quart", exp_var = c("per_age_wk_100"), start = km_start_100, data = main_cat_surv, title = "Glucose at 100% Life Expectancy", end = 180) 

nhp_surv_bw_50_all <- km_funct(quart = "bw_50_quart", exp_var = c("per_age_wk_50"), start = km_start_50, data = main_cat_surv, title = "Body Weight at 50% Life Expectancy", end = 180) 
nhp_surv_bw_75_all <- km_funct(quart = "bw_75_quart", exp_var = c("per_age_wk_75"), start = km_start_75, data = main_cat_surv, title = "Body Weight at 75% Life Expectancy", end = 180) 
nhp_surv_bw_100_all <- km_funct(quart = "bw_100_quart", exp_var = c("per_age_wk_100"), start = km_start_100, data = main_cat_surv, title = "Body Weight at 100% Life Expectancy", end = 180) 

nhp_surv_fat_50_all <- km_funct(quart = "fat_50_quart", exp_var = c("per_age_wk_50"), start = km_start_50, data = main_cat_surv, title = "Fat at 50% Life Expectancy", end = 180) 
nhp_surv_fat_75_all <- km_funct(quart = "fat_75_quart", exp_var = c("per_age_wk_75"), start = km_start_75, data = main_cat_surv, title = "Fat at 75% Life Expectancy", end = 180) 
nhp_surv_fat_100_all <- km_funct(quart = "fat_100_quart", exp_var = c("per_age_wk_100"), start = km_start_100, data = main_cat_surv, title = "Fat at 100% Life Expectancy", end = 180) 

```

```{r nhp_surv_output, warning=FALSE, message=FALSE, echo=FALSE}

#change font
nytimes <- "serif"

#add adjustment subscript
nhp_km_gluc_50 <- nhp_surv_gluc_50_all[[1]]$plot + ylim(-0.05, 1) + 
  annotate("text", x = -Inf, y = -0.05, hjust = -.09, label = deparse(bquote(HR[adj]== .(nhp_surv_gluc_50_all[[2]]))), size = 4, parse =TRUE, family = nytimes)
nhp_km_gluc_75 <- nhp_surv_gluc_75_all[[1]]$plot + ylim(-0.05, 1) + 
  annotate("text", x = -Inf, y = -0.05, hjust = -.09, label = deparse(bquote(HR[adj]== .(nhp_surv_gluc_75_all[[2]]))), size = 4, parse =TRUE, family = nytimes)
nhp_km_gluc_100 <- nhp_surv_gluc_100_all[[1]]$plot + ylim(-0.05, 1) + 
  annotate("text", x = -Inf, y = -0.05, hjust = -.09, label = deparse(bquote(HR[adj]== .(nhp_surv_gluc_100_all[[2]]))), size = 4, parse =TRUE, family = nytimes)

nhp_km_bw_50 <- nhp_surv_bw_50_all[[1]]$plot + ylim(-0.05, 1) + 
  annotate("text", x = -Inf, y = -0.05, hjust = -.09, label = deparse(bquote(HR[adj]== .(nhp_surv_bw_50_all[[2]]))), size = 4, parse =TRUE, family = nytimes)
nhp_km_bw_75 <- nhp_surv_bw_75_all[[1]]$plot + ylim(-0.05, 1) + 
  annotate("text", x = -Inf, y = -0.05, hjust = -.09, label = deparse(bquote(HR[adj]== .(nhp_surv_bw_75_all[[2]]))), size = 4, parse =TRUE, family = nytimes)
nhp_km_bw_100 <- nhp_surv_bw_100_all[[1]]$plot + ylim(-0.05, 1) + 
  annotate("text", x = -Inf, y = -0.05, hjust = -.09, label = deparse(bquote(HR[adj]== .(nhp_surv_bw_100_all[[2]]))), size = 4, parse =TRUE, family = nytimes)

nhp_km_fat_50 <- nhp_surv_fat_50_all[[1]]$plot + ylim(-0.05, 1) + 
  annotate("text", x = -Inf, y = -0.05, hjust = -.09, label = deparse(bquote(HR[adj]== .(nhp_surv_fat_50_all[[2]]))), size = 4, parse =TRUE, family = nytimes)
nhp_km_fat_75 <- nhp_surv_fat_75_all[[1]]$plot + ylim(-0.05, 1) + 
  annotate("text", x = -Inf, y = -0.05, hjust = -.09, label = deparse(bquote(HR[adj]== .(nhp_surv_fat_75_all[[2]]))), size = 4, parse =TRUE, family = nytimes)
nhp_km_fat_100 <- nhp_surv_fat_100_all[[1]]$plot + ylim(-0.05, 1) + 
  annotate("text", x = -Inf, y = -0.05, hjust = -.09, label = deparse(bquote(HR[adj]== .(nhp_surv_fat_100_all[[2]]))), size = 4, parse =TRUE, family = nytimes)
...
#function calls 
nhp_surv_gluc_50_all2 <- cph_funct(quart = "gluc_50_quart", exp_var = c("per_age_wk_50",  "sex"), data = main_cat_surv)
nhp_surv_gluc_75_all2 <- cph_funct(quart = "gluc_75_quart", exp_var = c("per_age_wk_75", "sex"), data = main_cat_surv)
nhp_surv_gluc_100_all2 <- cph_funct(quart = "gluc_100_quart", exp_var = c("per_age_wk_100", "sex"), data = main_cat_surv)

nhp_surv_bw_50_all2 <- cph_funct(quart = "bw_50_quart", exp_var = c("per_age_wk_50", "sex"), data = main_cat_surv)
nhp_surv_bw_75_all2 <- cph_funct(quart = "bw_75_quart", exp_var = c("per_age_wk_75", "sex"), data = main_cat_surv)
nhp_surv_bw_100_all2 <- cph_funct(quart = "bw_100_quart", exp_var = c("per_age_wk_100", "sex"), data = main_cat_surv)

nhp_surv_fat_50_all2 <- cph_funct(quart = "fat_50_quart", exp_var = c("per_age_wk_50", "sex"), data = main_cat_surv)
nhp_surv_fat_75_all2 <- cph_funct(quart = "fat_75_quart", exp_var = c("per_age_wk_75", "sex"), data = main_cat_surv)
nhp_surv_fat_100_all2 <- cph_funct(quart = "fat_100_quart", exp_var = c("per_age_wk_100", "sex"), data = main_cat_surv)

## by sex 
nhp_surv_gluc_50_f <- cph_funct(quart = "gluc_50_quart", exp_var = c("per_age_wk_50"), data = main_cat_surv_f) 
nhp_surv_gluc_75_f <- cph_funct(quart = "gluc_75_quart", exp_var = c("per_age_wk_75"), data = main_cat_surv_f) 
nhp_surv_gluc_100_f <- cph_funct(quart = "gluc_100_quart", exp_var = c("per_age_wk_100"), data = main_cat_surv_f) 

nhp_surv_bw_50_f <- cph_funct(quart = "bw_50_quart", exp_var = c("per_age_wk_50"), data = main_cat_surv_f) 
nhp_surv_bw_75_f <- cph_funct(quart = "bw_75_quart", exp_var = c("per_age_wk_75"), data = main_cat_surv_f) 
nhp_surv_bw_100_f <- cph_funct(quart = "bw_100_quart", exp_var = c("per_age_wk_100"), data = main_cat_surv_f) 

nhp_surv_fat_50_f <- cph_funct(quart = "fat_50_quart", exp_var = c("per_age_wk_50"), data = main_cat_surv_f) 
nhp_surv_fat_75_f <- cph_funct(quart = "fat_75_quart", exp_var = c("per_age_wk_75"), data = main_cat_surv_f) 
nhp_surv_fat_100_f <- cph_funct(quart = "fat_100_quart", exp_var = c("per_age_wk_100"), data = main_cat_surv_f) 

nhp_surv_gluc_50_m <- cph_funct(quart = "gluc_50_quart", exp_var = c("per_age_wk_50"), data = main_cat_surv_m)
nhp_surv_gluc_75_m <- cph_funct(quart = "gluc_75_quart", exp_var = c("per_age_wk_75"), data = main_cat_surv_m) 
nhp_surv_gluc_100_m <- cph_funct(quart = "gluc_100_quart", exp_var = c("per_age_wk_100"), data = main_cat_surv_m) 

nhp_surv_bw_50_m <- cph_funct(quart = "bw_50_quart", exp_var = c("per_age_wk_50"), data = main_cat_surv_m)
nhp_surv_bw_75_m <- cph_funct(quart = "bw_75_quart", exp_var = c("per_age_wk_75"), data = main_cat_surv_m) 
nhp_surv_bw_100_m <- cph_funct(quart = "bw_100_quart", exp_var = c("per_age_wk_100"), data = main_cat_surv_m) 

nhp_surv_fat_50_m <- cph_funct(quart = "fat_50_quart", exp_var = c("per_age_wk_50"), data = main_cat_surv_m)
nhp_surv_fat_75_m <- cph_funct(quart = "fat_75_quart", exp_var = c("per_age_wk_75"), data = main_cat_surv_m) 
nhp_surv_fat_100_m <- cph_funct(quart = "fat_100_quart", exp_var = c("per_age_wk_100"), data = main_cat_surv_m) 

## adjusted for body fat
nhp_surv_gluc_50_adj <- cph_funct(quart = "gluc_50_quart", exp_var = c("per_age_wk_50", "sex", "fat_50"), data = main_cat_surv)
nhp_surv_gluc_75_adj <- cph_funct(quart = "gluc_75_quart", exp_var = c("per_age_wk_75", "sex", "fat_75"), data = main_cat_surv)
nhp_surv_gluc_100_adj <- cph_funct(quart = "gluc_100_quart", exp_var = c("per_age_wk_100", "sex", "fat_100"), data = main_cat_surv)

## by sex
nhp_surv_gluc_50_adj_f <- cph_funct(quart = "gluc_50_quart", exp_var = c("per_age_wk_50", "fat_50"), data = main_cat_surv_f)
nhp_surv_gluc_75_adj_f <- cph_funct(quart = "gluc_75_quart", exp_var = c("per_age_wk_75", "fat_75"), data = main_cat_surv_f)
nhp_surv_gluc_100_adj_f <- cph_funct(quart = "gluc_100_quart", exp_var = c("per_age_wk_100", "fat_100"), data = main_cat_surv_f)

nhp_surv_gluc_50_adj_m <- cph_funct(quart = "gluc_50_quart", exp_var = c("per_age_wk_50", "fat_50"), data = main_cat_surv_m)
nhp_surv_gluc_75_adj_m <- cph_funct(quart = "gluc_75_quart", exp_var = c("per_age_wk_75", "fat_75"), data = main_cat_surv_m)
nhp_surv_gluc_100_adj_m <- cph_funct(quart = "gluc_100_quart", exp_var = c("per_age_wk_100", "fat_100"), data = main_cat_surv_m)
...
***
```{r nhp_hr_bodyfat_kable, warning=FALSE, message=FALSE, echo=FALSE, eval=TRUE, include=TRUE}

tablehr2 <- kable(nhp_hr_toc_by_3b, row.names = FALSE, col.names = c("Metabolic Index", "Timepoint$^‡$" , "All", "Female", "Male"), escape = FALSE, align = "c", caption = "Mortality Hazard Ratios of Highest and Lowest Body Weight and Fat Quartiles \n at Varying Timepoints Stratified by Sex") %>% 
  kable_styling(bootstrap_options = "striped", full_width = F, position = "left", font_size = 12) %>% 
  column_spec(1, bold = TRUE, border_right = T) %>% 
...
```{r nhp_lifespan_dist_fig, cache=TRUE}
