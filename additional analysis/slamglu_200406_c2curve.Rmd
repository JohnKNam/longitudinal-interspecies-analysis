...
#sex
slam_fig_i1 <- fcn_plotdist_smooth(metric = "gluc", x = "per_age_wk", xlabel = "Percent Life Expectancy", xlow = 0, xhigh = 150, 
...
#strain
slam_fig_j1 <- fcn_plotdist_smooth(metric = "gluc", x = "per_age_wk", xlabel = "Percent Life Expectancy", xlow = 0, xhigh = 150, 
...
#death
slam_fig_d1 <- fcn_plotdist_lm(metric = "gluc", x = "per_age_wk", xlabel = "Percent Life Expectancy", xlow = 0, xhigh = 150, 
...
slam_km_gluc_50 <- slam_surv_gluc_50_all[[1]]$plot +
  annotate("text", x = -Inf, y = .02, hjust = -.09, label = deparse(bquote(HR[adj]== .(slam_surv_gluc_50_all[[2]]))), size = 4, parse =TRUE)
slam_km_gluc_75 <- slam_surv_gluc_75_all[[1]]$plot +
  annotate("text", x = -Inf, y = .02, hjust = -.09, label = deparse(bquote(HR[adj]== .(slam_surv_gluc_75_all[[2]]))), size = 4, parse =TRUE)
slam_km_gluc_100 <- slam_surv_gluc_100_all[[1]]$plot +
  annotate("text", x = -Inf, y = .02, hjust = -.09, label = deparse(bquote(HR[adj]== .(slam_surv_gluc_100_all[[2]]))), size = 4, parse =TRUE)

slam_km_bw_50 <- slam_surv_bw_50_all[[1]]$plot +
  annotate("text", x = -Inf, y = .02, hjust = -.09, label = deparse(bquote(HR[adj]== .(slam_surv_bw_50_all[[2]]))), size = 4, parse =TRUE)
slam_km_bw_75 <- slam_surv_bw_75_all[[1]]$plot +
  annotate("text", x = -Inf, y = .02, hjust = -.09, label = deparse(bquote(HR[adj]== .(slam_surv_bw_75_all[[2]]))), size = 4, parse =TRUE)
slam_km_bw_100 <- slam_surv_bw_100_all[[1]]$plot +
  annotate("text", x = -Inf, y = .02, hjust = -.09, label = deparse(bquote(HR[adj]== .(slam_surv_bw_100_all[[2]]))), size = 4, parse =TRUE)

slam_km_fat_50 <- slam_surv_fat_50_all[[1]]$plot +
  annotate("text", x = -Inf, y = .02, hjust = -.09, label = deparse(bquote(HR[adj]== .(slam_surv_fat_50_all[[2]]))), size = 4, parse =TRUE)
slam_km_fat_75 <- slam_surv_fat_75_all[[1]]$plot +
  annotate("text", x = -Inf, y = .02, hjust = -.09, label = deparse(bquote(HR[adj]== .(slam_surv_fat_75_all[[2]]))), size = 4, parse =TRUE)
slam_km_fat_100 <- slam_surv_fat_100_all[[1]]$plot +
  annotate("text", x = -Inf, y = .02, hjust = -.09, label = deparse(bquote(HR[adj]== .(slam_surv_fat_100_all[[2]]))), size = 4, parse =TRUE)
...
```{r slam_ss_dist_funct2, warning=FALSE, message=FALSE, echo=FALSE, eval=TRUE}
...
fcn_plotdist_smooth2 <- function(metric, x, y, by, xlabel, ylabel, title, xlow, xhigh, filter) { 
  ...
  ggplot(subset(df, eval(parse(text = sub))), aes_string(x = x, y = y)) + 
    ...
    #trendlines 
    geom_smooth(aes_string(linetype = "solid"), linetype = "solid", color = "black", size = 1.8) +
    geom_smooth(aes(linetype = "solid")) + 
...
```{r slam_ss_dist_plots2, warning=FALSE, message=FALSE, echo=FALSE, eval=TRUE}

cbPalette_dot <- c("#f8766d", "#00b0f6", "black") 

#sex
c2_1 <- fcn_plotdist_smooth2(metric = "gluc", x = "per_age_wk", xlabel = "Percent Life Expectancy", xlow = 0, xhigh = 150, 
                        y = "gluc", ylabel = "Glucose (mg/dL)", by = "sex", filter= quote(sexstrain %in% "HET3 M"))+ ggtitle("HET3 Male") + 
  ylim(90,220)
c2_2 <- fcn_plotdist_smooth2(metric = "gluc", x = "per_age_wk", xlabel = "Percent Life Expectancy", xlow = 0, xhigh = 150, 
                        y = "gluc", ylabel = "Glucose (mg/dL)", by = "sex", filter= quote(sexstrain %in% "HET3 F")) + ggtitle("HET3 Female") + 
  ylim(90,220)
c2_3 <- fcn_plotdist_smooth2(metric = "gluc", x = "per_age_wk", xlabel = "Percent Life Expectancy", xlow = 0, xhigh = 150, 
                        y = "gluc", ylabel = "Glucose (mg/dL)", by = "sex", filter= quote(sexstrain %in% "B6 M")) + ggtitle("B6 Male") + 
  ylim(90,220)
c2_4 <- fcn_plotdist_smooth2(metric = "gluc", x = "per_age_wk", xlabel = "Percent Life Expectancy", xlow = 0, xhigh = 150, 
                        y = "gluc", ylabel = "Glucose (mg/dL)", by = "sex", filter= quote(sexstrain %in% "B6 F")) + ggtitle("B6 Female") + 
  ylim(90,220)
 
#
cohort2 <- ggarrange(c2_1, c2_2, c2_3, c2_4,
                      ncol = 2, nrow = 2, 
                     common.legend = TRUE, 
                     legend = "right") 
...
```{r slam_sex_dist_fig2, warning=FALSE, message=FALSE, echo=FALSE, eval=TRUE}

annotate_figure(cohort2, 
