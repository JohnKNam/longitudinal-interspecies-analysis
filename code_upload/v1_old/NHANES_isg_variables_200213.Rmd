...
cohort_all2 <- cohort_all %>% 
  dplyr::select(SEQN, Cohort, AGE, GENDER, RACE, Plasma_Glucose, PG_Weight) 
...
cohort_all2 <- cohort_all2 %>% 
   mutate(GENDER = factor(GENDER, 
          ...
          RACE = factor(RACE, 
              labels = c("Mexican American", "Other Hispanic","Non-Hispanic White","Non-Hispanic Black","Other Race/Multi-Racial")), 
          Cohort = factor(Cohort, 
              labels =  c("1999-2000","2001-2002","2003-2004","2005-2006","2007-2008","2009-2010","2011-2012","2013-2014","2015-2016")))

PG <- cohort_all2 %>% 
  filter(!is.na(Plasma_Glucose)) 

cohort_all2 <- cohort_all2 %>% 
  filter(PG_Weight != 0, !is.na(PG_Weight)) 

#Means 
nhanes_main_all <- cohort_all2 
