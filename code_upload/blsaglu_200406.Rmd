...
blsa_km_gluc_50 <- blsa_surv_gluc_50_all[[1]]$plot + ylim(-0.05, 1) + 
  annotate("text", x = -Inf, y = -0.05, hjust = -.09, label = deparse(bquote(HR[adj]== .(blsa_surv_gluc_50_all[[2]]))), size = 4, parse =TRUE, family = nytimes)
blsa_km_gluc_75 <- blsa_surv_gluc_75_all[[1]]$plot + ylim(-0.05, 1) + 
  annotate("text", x = -Inf, y = -0.05, hjust = -.09, label = deparse(bquote(HR[adj]== .(blsa_surv_gluc_75_all[[2]]))), size = 4, parse =TRUE, family = nytimes)
blsa_km_gluc_100 <- blsa_surv_gluc_100_all[[1]]$plot + ylim(-0.05, 1) + 
  annotate("text", x = -Inf, y = -0.05, hjust = -.09, label = deparse(bquote(HR[adj]== .(blsa_surv_gluc_100_all[[2]]))), size = 4, parse =TRUE, family = nytimes)

blsa_km_bw_50 <- blsa_surv_bw_50_all[[1]]$plot + ylim(-0.05, 1) + 
  annotate("text", x = -Inf, y = -0.05, hjust = -.09, label = deparse(bquote(HR[adj]== .(blsa_surv_bw_50_all[[2]]))), size = 4, parse =TRUE, family = nytimes)
blsa_km_bw_75 <- blsa_surv_bw_75_all[[1]]$plot + ylim(-0.05, 1) + 
  annotate("text", x = -Inf, y = -0.05, hjust = -.09, label = deparse(bquote(HR[adj]== .(blsa_surv_bw_75_all[[2]]))), size = 4, parse =TRUE, family = nytimes)
blsa_km_bw_100 <- blsa_surv_bw_100_all[[1]]$plot + ylim(-0.05, 1) + 
  annotate("text", x = -Inf, y = -0.05, hjust = -.09, label = deparse(bquote(HR[adj]== .(blsa_surv_bw_100_all[[2]]))), size = 4, parse =TRUE, family = nytimes)

blsa_km_fat_50 <- blsa_surv_fat_50_all[[1]]$plot + ylim(-0.05, 1) + 
  annotate("text", x = -Inf, y = -0.05, hjust = -.09, label = deparse(bquote(HR[adj]== .(blsa_surv_fat_50_all[[2]]))), size = 4, parse =TRUE, family = nytimes)
blsa_km_fat_75 <- blsa_surv_fat_75_all[[1]]$plot + ylim(-0.05, 1) + 
  annotate("text", x = -Inf, y = -0.05, hjust = -.09, label = deparse(bquote(HR[adj]== .(blsa_surv_fat_75_all[[2]]))), size = 4, parse =TRUE, family = nytimes)
blsa_km_fat_100 <- blsa_surv_fat_100_all[[1]]$plot + ylim(-0.05, 1) + 
  annotate("text", x = -Inf, y = -0.05, hjust = -.09, label = deparse(bquote(HR[adj]== .(blsa_surv_fat_100_all[[2]]))), size = 4, parse =TRUE, family = nytimes)
